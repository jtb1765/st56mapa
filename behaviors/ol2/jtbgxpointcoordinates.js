(function($) {
	 ...
	 * 
	 */
	Drupal.behaviors.st56mapa_control_pointcoordinates = {
		'attach': function(context, settings) {
			$('.jmapas-map').once('jmapas-control-point-coordinates', function() {
				//
				...
				OpenLayers.Control.Click = OpenLayers.Class(OpenLayers.Control, {
					...
					initialize: function(options2) {
						...
						this.handler = new OpenLayers.Handler.Click(
								this, {
									'click':Drupal.st56mapa.pointCoordinates
									}, this.handlerOptions
									);
					}
				});
				...
				//
				var container = settings.st56mapa.map_datos.containers['jtbgxpointcoordinates'];
				var opciones = settings.st56mapa.map_datos.controles[container].jtbgxpointcoordinates.opciones;			
				settings.st56mapa.map_datos[container].push(new GeoExt.Action({
	              ...
	              iconCls: "jtbPointCoordinatesItemActive",
	              //check items options
	              group: "jtbgxtoolbar",
	              //checked: true
	            }));
